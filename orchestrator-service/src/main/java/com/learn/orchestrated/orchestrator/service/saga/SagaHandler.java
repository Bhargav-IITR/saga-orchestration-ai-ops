...
public final class SagaHandler {
    ...
    public static final Object[][] SAGA_HANDLER = {
            ...
            { FRAUD_VALIDATION_SERVICE, ROLLBACK, FRAUD_VALIDATION_FAIL },
            { FRAUD_VALIDATION_SERVICE, FAIL, PRODUCT_VALIDATION_FAIL },
            { FRAUD_VALIDATION_SERVICE, SUCCESS, PAYMENT_SUCCESS },
